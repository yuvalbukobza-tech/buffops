...
jsx = jsx.replace(
    ...
    '  const CORRECT_USER = "yuvalbukobza";\n'
    '  const CORRECT_PASS = "071198";\n'
    '\n'
    '  const [tab,        setTab]        = useState("overview");\n'
    ...
    '    e.preventDefault();\n'
    '    if (loginU === CORRECT_USER && loginP === CORRECT_PASS) {\n'
...
jsx = jsx.replace(
    ...
    '        ))}\n'
    '        <div style={{marginLeft:"auto",display:"flex",alignItems:"center",gap:8,fontSize:12,fontWeight:600,paddingRight:8}}>\n'
